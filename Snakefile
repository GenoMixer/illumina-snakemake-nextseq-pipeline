...
def get_fq1(wildcards):
        return sorted(glob.glob("Alignment_1/*/Fastq/" + wildcards.sample + "_*_L*_R1_001.fq.gz"))

def get_fq2(wildcards):
        return sorted(glob.glob("Alignment_1/*/Fastq/" + wildcards.sample + "_*_L*_R2_001.fq.gz"))
